...
| [`client-ui-settings-archive`](../packages/client/ui-settings-archive) | `client` | — |
...
| [`client-ui-settings-plugin-installer`](../packages/client/ui-settings-plugin-installer) | `client` | — |
