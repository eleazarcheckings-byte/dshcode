...
来源：[`packages/host/plugin-installer/src/index.ts:135`](../packages/host/plugin-installer/src/index.ts)
...
需要：`settings` · `tools` · `systemPrompt` · `loader`
...
来源：[`packages/saturn/model-router/src/types.ts:46`](../packages/saturn/model-router/src/types.ts)
...
需要：`webServer` · `connection` · `settings`
...
来源：[`packages/saturn/remote-access/src/index.ts:70`](../packages/saturn/remote-access/src/index.ts)

<a id="saturnaidsh-review"></a>

## `@saturnai/dsh-review`

需要：`subagents` · `tools` · `sessionProjections`
...
来源：[`packages/saturn/review/src/index.ts:66`](../packages/saturn/review/src/index.ts)

<a id="saturnaidsh-saturnbot"></a>

## `@saturnai/dsh-saturnbot`

需要：`llm` · `sessions` · `sessionPersistence` · `subprocess`
...
来源：[`packages/saturn/saturnbot/src/index.ts:34`](../packages/saturn/saturnbot/src/index.ts)
...
来源：[`packages/skill/skill-premium-output/src/index.ts:21`](../packages/skill/skill-premium-output/src/index.ts)
...
来源：[`packages/saturn/tool-media/src/index.ts:106`](../packages/saturn/tool-media/src/index.ts)
...
- `@deepseek-ai/dsh-api-workspace-controller` — 需要 `typert` · `workspaceRegistry` · `sessionPersistence` · `sessions`（[`packages/api/workspace-controller/src/index.ts`](../packages/api/workspace-controller/src/index.ts)）
...
- `@deepseek-ai/dsh-host-file-picker-native`（[`packages/host/file-picker-native/src/index.ts`](../packages/host/file-picker-native/src/index.ts)）
...
- `@deepseek-ai/dsh-host-file-picker` — 抽象 `FilePicker`（[`packages/host/file-picker/src/index.ts`](../packages/host/file-picker/src/index.ts)）
