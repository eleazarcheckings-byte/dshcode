...
Source: [`packages/hooks/hooks-claude-code/src/index.ts:55`](../packages/hooks/hooks-claude-code/src/index.ts)
...
Source: [`packages/llm/llm-deepseek/src/index.ts:150`](../packages/llm/llm-deepseek/src/index.ts)
...
Source: [`packages/mcp/mcp-config-claude/src/index.ts:89`](../packages/mcp/mcp-config-claude/src/index.ts)
...
Source: [`packages/schedule/schedule-durable/src/index.ts:59`](../packages/schedule/schedule-durable/src/index.ts)
...
Source: [`packages/browser/tool-browser/src/index.ts:53`](../packages/browser/tool-browser/src/index.ts)
...
Source: [`packages/fs/tool-document/src/index.ts:50`](../packages/fs/tool-document/src/index.ts)
...
Source: [`packages/saturn/agent-team/src/types.ts:155`](../packages/saturn/agent-team/src/types.ts)
...
Source: [`packages/saturn/design-brain/src/index.ts:33`](../packages/saturn/design-brain/src/index.ts)
...
Source: [`packages/saturn/gates/src/policy.ts:25`](../packages/saturn/gates/src/policy.ts)
...
Source: [`packages/saturn/orchestrate/src/index.ts:42`](../packages/saturn/orchestrate/src/index.ts)
...
- `@deepseek-ai/dsh-api-workspace-controller` — requires `typert` · `workspaceRegistry` · `sessionPersistence` · `sessions` ([`packages/api/workspace-controller/src/index.ts`](../packages/api/workspace-controller/src/index.ts))
...
- `@saturnai/dsh-checkpoints` — requires `sessionProjections` ([`packages/saturn/checkpoints/src/index.ts`](../packages/saturn/checkpoints/src/index.ts))
- `@saturnai/dsh-claims` — requires `tools` · `systemPrompt` ([`packages/saturn/claims/src/index.ts`](../packages/saturn/claims/src/index.ts))
...
- `@deepseek-ai/dsh-host-file-picker` — abstract `FilePicker` ([`packages/host/file-picker/src/index.ts`](../packages/host/file-picker/src/index.ts))
