...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface SlotMap {
    ...
    /**
     * One decorative background beneath every column, outside their scroll
     * containers. The frame hides this layer from assistive technology and
     * pointer input; controls belong in an ordinary interactive slot.
     *
     * The optional Session scope supplies current input and session hooks
     * without remounting the occupant when the current Session changes.
     */
