...
export const zh = {
  ...
  'hf.error.credits': 'Hugging Face 额度已用完，请在 huggingface.co/settings/billing 充值。',
  'hf.error.gated': '该模型需授权：请先在 huggingface.co 上用令牌所属账号接受其许可协议。',
  ...
  'message.deleteTurn': '删除本轮对话',
  'message.menu.aria': '消息操作',
  'message.showInFolder': '在文件夹中显示',
  'message.deleteConfirm.title': '删除本轮对话？',
  'message.deleteConfirm.body': '该轮对话将从记录与模型可见的历史中移除，且无法撤销。',
  'message.continue': '继续',
  'message.continue.title': '本轮在完成前被中断；继续让模型接着输出',
  'message.edit': '编辑',
...
export const en = {
  ...
  'hf.error.gated': 'This model is gated. Accept its license on huggingface.co with the account that owns the token.',
  ...
  'message.deleteTurn': 'Delete turn',
  'message.menu.aria': 'Message actions',
  'message.showInFolder': 'Show in folder',
  'message.deleteConfirm.title': 'Delete this turn?',
  'message.deleteConfirm.body': 'The turn is removed from the transcript and from the model-visible history. This cannot be undone.',
  'message.continue': 'Continue',
  'message.continue.title': 'This turn stopped before it finished; continue to let the model resume',
  'message.edit': 'Edit',
