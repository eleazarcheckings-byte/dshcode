...
When the built-in `archive` section is registered, navigation hides the community `archive-manager` section. Removing the built-in contribution reveals the community entry again; other sections remain available.
