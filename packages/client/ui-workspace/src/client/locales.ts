...
export const zh = {
  'jump.title': '快速跳转',
  'jump.shortcutMac': '⌘ K',
  'jump.shortcut': 'Ctrl K',
  'jump.launcher': '搜索与跳转',
  'jump.placeholder': '查找会话、项目或操作…',
  'jump.escape': 'Esc',
  'jump.recent': '继续你的工作',
  'jump.results': '搜索结果',
  'jump.new': '开始新任务',
  'jump.newDetail': '在当前工作区开始',
  'jump.action': '操作',
  'jump.workspace': '项目',
  'jump.session': '会话',
  'jump.waiting': '需要你处理',
  'jump.empty': '未找到匹配结果',
  'jump.emptyDetail': '尝试会话名称、项目或路径。',
  'jump.navigate': '↑ ↓ 选择',
  'jump.open': '↵ 打开',
  'jump.local': '即时 · 本地搜索',
  'group.ungrouped': '未分组',
  ...
  'menu.session.aria': '会话操作',
  'menu.showInFolder': '在文件夹中显示',
  'menu.workspace.aria': '工作区操作',
...
export const en = {
  'jump.title': 'Quick switch',
  'jump.shortcutMac': '⌘ K',
  'jump.shortcut': 'Ctrl K',
  'jump.launcher': 'Search & jump',
  'jump.placeholder': 'Find a conversation, project, or action…',
  'jump.escape': 'Esc',
  'jump.recent': 'Pick up where you left off',
  'jump.results': 'Matching destinations',
  'jump.new': 'Start a new task',
  'jump.newDetail': 'Begin in your current workspace',
  'jump.action': 'Action',
  'jump.workspace': 'Project',
  'jump.session': 'Conversation',
  'jump.waiting': 'Needs you',
  'jump.empty': 'No matches yet',
  'jump.emptyDetail': 'Try a conversation name, project, or path.',
  'jump.navigate': '↑ ↓ Navigate',
  'jump.open': '↵ Open',
  'jump.local': 'Instant · Local search',
  ...
  'reveal.failed.title': 'Couldn’t show in folder',
  'rename': 'Rename',
  ...
  'menu.session.aria': 'Session actions',
  'menu.showInFolder': 'Show in folder',
  'menu.workspace.aria': 'Workspace actions',
