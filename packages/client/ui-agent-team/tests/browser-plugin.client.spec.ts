...
import type { TeamMemberView as TeamRosterMember, TeamTaskId } from '@saturnai/dsh-agent-team/client'
import type {} from '@saturnai/dsh-agent-team/remote'
...
const REMOTE: TypertRemoteContribution = {
  package: '@saturnai/dsh-agent-team',
  descriptors: [],
}
