...
export const en = {
  ...
  firstLightModelReady: 'A model is already connected.',
  firstLightModelUnavailable: 'Model setup is not available in this build. You can add one later in Settings.',
  firstLightBrainTitle: 'Design brain',
  firstLightBrainBody: 'Connect the design and brand layer so your work can draw on it.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  onboardingDescription: '配置 DeepSeek 模型提供方，即可开始使用。',
  ...
  firstLightModelReady: '已连接一个模型。',
  firstLightModelUnavailable: '当前版本暂不可配置模型，可稍后在设置中添加。',
  firstLightBrainTitle: '设计大脑',
  firstLightBrainBody: '连接设计与品牌层，让工作可以调用它。',
