...
export const zh = {
  ...
  'input.send': '发送消息',
  'input.addFiles': '添加文件',
  'file.locateFailed': '无法定位文件：{names}，请点击「添加文件」按钮选择',
  ...
  'usage.aria': '{input} 入 · {output} 出',
  'usage.tooltip': '本会话用量：输入 {input}，输出 {output}',
  ...
  'hero.headline': '构建非凡之作。',
  'hero.headlineFor': '欢迎，{name}。一起构建{building}。',
  'hero.preview': 'Saturn',
  'hero.workspace': '智能体工作空间',
  'hero.description': '探索想法、编写代码，让下一项工作真正落地。',
  'hero.motion': '动态效果',
  'hero.motionLabel': '环境动画偏好',
  'hero.motionHint': '书写时暂停动画，并始终尊重系统的减少动态效果偏好。',
  'hero.starter.build.title': '构建新功能',
  'hero.starter.build.detail': '从想法到实现',
  'hero.starter.build.prompt': '我想在这个项目中构建一个新功能。先了解项目，然后帮我明确需求并制定实现计划。',
  'hero.starter.explore.title': '了解代码库',
  'hero.starter.explore.detail': '找到值得关注的部分',
  'hero.starter.explore.prompt': '探索这个代码库。解释它的结构、关键设计决策，以及开始修改前最需要了解的部分。',
  'hero.starter.review.title': '审查代码变更',
  'hero.starter.review.detail': '发现风险并改进',
  'hero.starter.review.prompt': '审查这个项目中当前未提交的变更。找出重要缺陷、风险和缺失的测试，并按优先级整理具体建议。',
  'hero.chooseWorkspace': '选择工作区',
  'pricing.peak': '高峰',
  'pricing.offPeak': '低峰',
  'pricing.tooltip.peak': '高峰时段 · 低峰切换于 {time}',
  'pricing.tooltip.offPeak': '低峰时段（半价）· 高峰切换于 {time}',
  ...
  'approval.confirmShortcut': '⌘/Ctrl+Enter 允许一次',
  'ask.rowTitle': '提问',
  'ask.waiting': '等待回答',
  'ask.cancelled': '已取消',
...
export const en = {
  ...
  'approval.confirmShortcut': '⌘/Ctrl+Enter to allow once',
  ...
  'usage.aria': '{input} in · {output} out',
  'usage.tooltip': 'This session: {input} input, {output} output',
  ...
  'file.locateFailed': 'Cannot locate {names}; use the add-file button',
  ...
  'hero.headline': 'Build something extraordinary.',
  'hero.headlineFor': 'Welcome, {name}. Let’s build {building}.',
  'hero.preview': 'Saturn',
  'hero.workspace': 'Agent workspace',
  'hero.description': 'Explore an idea. Build with intention. Bring your next project to life.',
  'hero.motion': 'Motion',
  'hero.motionLabel': 'Ambient motion preference',
  'hero.motionHint': 'Pauses while you write. Always respects your system’s reduced-motion preference.',
  'hero.starter.build.title': 'Build a feature',
  'hero.starter.build.detail': 'Take an idea into production',
  'hero.starter.build.prompt': 'I want to build a new feature in this project. First understand the project, then help me clarify the requirements and make an implementation plan.',
  'hero.starter.explore.title': 'Explore the codebase',
  'hero.starter.explore.detail': 'Find what matters',
  'hero.starter.explore.prompt': 'Explore this codebase. Explain its structure, key design decisions, and the most useful things to understand before making changes.',
  'hero.starter.review.title': 'Review changes',
  'hero.starter.review.detail': 'Catch risks before shipping',
  'hero.starter.review.prompt': 'Review the current uncommitted changes in this project. Find important bugs, risks, and missing tests, then give me concrete findings in priority order.',
  'pricing.peak': 'Peak',
  'pricing.offPeak': 'Off-peak',
  'pricing.tooltip.peak': 'Peak pricing · off-peak at {time}',
  'pricing.tooltip.offPeak': 'Off-peak pricing (½ price) · peak at {time}',
  ...
  'row.input': 'IN',
  'row.inspect': 'Inspect',
  'row.openFile': 'Open file',
  'row.showInFolder': 'Show in folder',
  'row.menu.aria': 'File actions',
  'row.output': 'OUT',
  'row.running': 'Running',
  'row.stopped': 'Stopped',
