...
| [`skill-badge/`](skill-badge/README.zh.md) | 随包附带官方「powered by Saturn AI」徽章 skill，默认禁用 | 注册到 `ctx.skills` |
| [`skill-premium-output/`](skill-premium-output/README.zh.md) | 共享产出质量策略及内置网站、动效与交付物工作流 | 注册到 `ctx.skills` 和 `ctx.systemPrompt` |
