...
| [`skill-badge/`](skill-badge/README.md) | Bundles the official "powered by Saturn AI" badge skill, disabled by default | registers on `ctx.skills` |
| [`skill-premium-output/`](skill-premium-output/README.md) | Shared output-quality policy and packaged website, motion, and artifact workflows | registers on `ctx.skills` and `ctx.systemPrompt` |
