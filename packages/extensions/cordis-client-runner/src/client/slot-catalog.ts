...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      '@saturnai/dsh-client-ui-fleet FleetRoute id \'fleet\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation.composer.bar\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      '@saturnai/dsh-client-ui-orchestrate OrchestrateToggle id \'multi-task\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'session-maybe',
    summary: 'The input selector row\'s context hole, rendered in every conversation phase right above the composer card — session-maybe chips that ride beside the workspace selector (the git branch chip).',
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.input.selector.context\', () => ctx.slots.register(\n      { name: \'conversation.input.selector.context\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    occupants: [
      ...
      '@saturnai/dsh-client-ui-agent-team TeamAction id \'agent-team\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-notifications NotificationsSection id \'notifications\'',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'sidebar.settings\' (client-ui-settings-general), so it exists while that entry is mounted',
    occupants: [
      'client-ui-settings-models FirstLight id \'first-light\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-plugins DescribeImageCard',
  ...
  },
  {
    ...
    occupants: [
      'client-ui-settings-plugin-installer PluginInstallerTab id \'plugins\'',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-conversation AmbientSky',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-conversation AmbientMotionControl id \'ambient-motion\'',
      'client-ui-conversation PeakRail id \'deepseek-peak\'',
      '@saturnai/dsh-client-ui-saturnbot SaturnBotEntry id \'saturnbot\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'shell.overlay\', () => ctx.slots.register(\n      { name: \'shell.overlay\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-layout/src/client/index.ts:103',
  },
  {
    key: 'sidebar',
    kind: 'single',
  ...
  },
  {
    ...
    occupants: [
      ...
      '@saturnai/dsh-client-ui-brand-saturn SaturnGlyph',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      '@saturnai/dsh-client-ui-brand-saturn SaturnName',
    ],
    replaceRisk: 'shadows-shipped-ui',
