...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  remoteAccess: 'web-server.md',
  media: 'tools.md',
  modelRouter: 'core.md',
  designBrain: 'tools.md',
  claims: 'workspace.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  profileUserPatchPath: 'not a service: launcher-provided active-profile patch path (string | undefined) for trusted Host plugins — packages/boot/app-boot/README.md owns the boot contract',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SessionDeleteMessageRequest: 'session.md',
  SessionDeleteMessageValue: 'session.md',
  ...
  SessionEditMessageRequest: 'session.md',
  SessionEditMessageValue: 'session.md',
  ...
  WorkspaceListArchivedValue: 'workspace.md',
  ...
  FilePickerCapability: 'workspace.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  MergeTeammateRequest: 'teammate-merge request is owned by packages/saturn/agent-team/src/types.ts',
  MergeTeammateResult: 'teammate-merge result is owned by packages/saturn/agent-team/src/types.ts',
  ClaimCheckRequest: 'path-claim check request is owned by packages/saturn/claims/src/service.ts',
  ClaimPathConflict: 'path-claim conflict record is owned by packages/saturn/claims/src/service.ts',
  DesignBrainStatus: 'design-brain connection status is owned by packages/saturn/design-brain/src/types.ts',
  BoundMediaService: 'agent-bound media service view is owned by packages/saturn/tool-media/src/index.ts',
  MediaExecContext: 'per-call media execution context is owned by packages/saturn/tool-media/src/index.ts',
  MediaGenerateRequest: 'media generation request is owned by packages/saturn/tool-media/src/types.ts',
  MediaJob: 'media generation result is owned by packages/saturn/tool-media/src/types.ts',
